<?php
    ...
    switch ($method){ 
        ...
        break; 
        case "DELETE": // Delete work
        if($work->deleteWork($input['id'])) { 
            http_response_code(201); // work was successfully deleted
        ...
        break;
        case "PUT": // Update work
        if($work->updateWork($input['id'], $input['startdate'], $input['enddate'], $input['work'], 
            $input['title'], $input['url'])) { 
            http_response_code(201); // work was successfully updated 
